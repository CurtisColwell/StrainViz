# Minimum value: 0.063061516955
# Maximum value: 3.00671251105
...
mol modcolor 10 top {colorid 25}
mol modselect 10 top {index 17 16}

mol addrep top
mol modstyle 11 top bonds
mol modcolor 11 top {colorid 7}
...
mol modcolor 13 top {colorid 19}
...
mol modcolor 15 top {colorid 19}
mol modselect 15 top {index 22 21}

mol addrep top
mol modstyle 16 top bonds
mol modcolor 16 top {colorid 17}
...
mol modcolor 18 top {colorid 15}
...
mol modcolor 21 top {colorid 18}
...
mol modcolor 24 top {colorid 8}
mol modselect 24 top {index 30 2}

mol addrep top
mol modstyle 25 top bonds
mol modcolor 25 top {colorid 14}
...
mol modcolor 34 top {colorid 13}
mol modselect 34 top {index 44 24}

mol addrep top
mol modstyle 35 top bonds
mol modcolor 35 top {colorid 5}
