# Minimum value: 0.000179826657811
...
mol modcolor 10 top {colorid 10}
mol modselect 10 top {index 5 10}

mol addrep top
mol modstyle 11 top bonds
mol modcolor 11 top {colorid 13}
...
mol modcolor 19 top {colorid 3}
mol modselect 19 top {index 10 35}

mol addrep top
mol modstyle 20 top bonds
mol modcolor 20 top {colorid 9}
...
mol modcolor 24 top {colorid 4}
mol modselect 24 top {index 16 27}

mol addrep top
mol modstyle 25 top bonds
mol modcolor 25 top {colorid 9}
...
mol modcolor 37 top {colorid 11}
mol modselect 37 top {index 23 24}

mol addrep top
mol modstyle 38 top bonds
mol modcolor 38 top {colorid 12}
