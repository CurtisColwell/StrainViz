# Minimum value: 0.0602315319785
# Maximum value: 6.73068494779
...
mol modcolor 6 top {colorid 13}
mol modselect 6 top {index 8 7}

mol addrep top
mol modstyle 7 top bonds
mol modcolor 7 top {colorid 11}
...
mol modcolor 10 top {colorid 14}
...
mol modcolor 17 top {colorid 31}
mol modselect 17 top {index 23 8}

mol addrep top
mol modstyle 18 top bonds
mol modcolor 18 top {colorid 12}
mol modselect 18 top {index 23 22}

mol addrep top
mol modstyle 19 top bonds
mol modcolor 19 top {colorid 11}
mol modselect 19 top {index 24 23}

mol addrep top
mol modstyle 20 top bonds
mol modcolor 20 top {colorid 13}
mol modselect 20 top {index 25 20}

mol addrep top
mol modstyle 21 top bonds
mol modcolor 21 top {colorid 12}
mol modselect 21 top {index 25 24}

mol addrep top
mol modstyle 22 top bonds
mol modcolor 22 top {colorid 11}
