# Minimum value: 0.060582856405
# Maximum value: 2.96906824614
...
mol modcolor 19 top {colorid 18}
mol modselect 19 top {index 23 8}

mol addrep top
mol modstyle 20 top bonds
mol modcolor 20 top {colorid 16}
mol modselect 20 top {index 24 23}
...
mol modcolor 23 top {colorid 10}
...
mol modselect 32 top {index 38 13}

mol addrep top
mol modstyle 33 top bonds
mol modcolor 33 top {colorid 13}
mol modselect 33 top {index 39 14}

mol addrep top
mol modstyle 34 top bonds
mol modcolor 34 top {colorid 14}
...
mol modcolor 36 top {colorid 7}
mol modselect 36 top {index 44 24}

mol addrep top
mol modstyle 37 top bonds
mol modcolor 37 top {colorid 9}
