# Minimum value: 0.050756065465
# Maximum value: 0.204881751251
...
mol modcolor 1 top {colorid 25}
mol modselect 1 top {index 3 2}

mol addrep top
mol modstyle 2 top bonds
mol modcolor 2 top {colorid 31}
mol modselect 2 top {index 4 3}

mol addrep top
mol modstyle 3 top bonds
mol modcolor 3 top {colorid 26}
mol modselect 3 top {index 5 4}

mol addrep top
mol modstyle 4 top bonds
mol modcolor 4 top {colorid 22}
mol modselect 4 top {index 6 5}

mol addrep top
mol modstyle 5 top bonds
mol modcolor 5 top {colorid 1}
mol modselect 5 top {index 7 6}

mol addrep top
mol modstyle 6 top bonds
mol modcolor 6 top {colorid 20}
mol modselect 6 top {index 8 7}

mol addrep top
mol modstyle 7 top bonds
mol modcolor 7 top {colorid 21}
mol modselect 7 top {index 9 8}
...
mol modselect 12 top {index 18 17}

mol addrep top
mol modstyle 13 top bonds
mol modcolor 13 top {colorid 20}
mol modselect 13 top {index 19 18}

mol addrep top
mol modstyle 14 top bonds
mol modcolor 14 top {colorid 25}
mol modselect 14 top {index 20 19}

mol addrep top
mol modstyle 15 top bonds
mol modcolor 15 top {colorid 22}
mol modselect 15 top {index 21 20}

mol addrep top
mol modstyle 16 top bonds
mol modcolor 16 top {colorid 3}
mol modselect 16 top {index 22 21}

mol addrep top
mol modstyle 17 top bonds
mol modcolor 17 top {colorid 20}
mol modselect 17 top {index 23 22}

mol addrep top
mol modstyle 18 top bonds
mol modcolor 18 top {colorid 6}
mol modselect 18 top {index 23 8}

mol addrep top
mol modstyle 19 top bonds
mol modcolor 19 top {colorid 22}
mol modselect 19 top {index 24 23}

mol addrep top
mol modstyle 20 top bonds
mol modcolor 20 top {colorid 1}
mol modselect 20 top {index 25 24}

mol addrep top
mol modstyle 21 top bonds
mol modcolor 21 top {colorid 21}
mol modselect 21 top {index 25 20}

mol addrep top
mol modstyle 22 top bonds
mol modcolor 22 top {colorid 30}
mol modselect 22 top {index 26 19}

mol addrep top
mol modstyle 23 top bonds
mol modcolor 23 top {colorid 24}
mol modselect 23 top {index 27 26}

mol addrep top
mol modstyle 24 top bonds
mol modcolor 24 top {colorid 9}
mol modselect 24 top {index 30 2}

mol addrep top
mol modstyle 25 top bonds
mol modcolor 25 top {colorid 5}
...
mol modcolor 30 top {colorid 3}
mol modselect 30 top {index 36 11}

mol addrep top
mol modstyle 31 top bonds
mol modcolor 31 top {colorid 4}
mol modselect 31 top {index 37 12}

mol addrep top
mol modstyle 32 top bonds
mol modcolor 32 top {colorid 5}
mol modselect 32 top {index 40 17}

mol addrep top
mol modstyle 33 top bonds
mol modcolor 33 top {colorid 3}
mol modselect 33 top {index 41 18}

mol addrep top
mol modstyle 34 top bonds
mol modcolor 34 top {colorid 4}
mol modselect 34 top {index 42 21}

mol addrep top
mol modstyle 35 top bonds
mol modcolor 35 top {colorid 4}
mol modselect 35 top {index 43 22}

mol addrep top
mol modstyle 36 top bonds
mol modcolor 36 top {colorid 4}
mol modselect 36 top {index 44 24}

mol addrep top
mol modstyle 37 top bonds
mol modcolor 37 top {colorid 3}
mol modselect 37 top {index 45 25}

mol addrep top
mol modstyle 38 top bonds
mol modcolor 38 top {colorid 5}
mol modselect 38 top {index 46 26}

mol addrep top
mol modstyle 39 top bonds
mol modcolor 39 top {colorid 9}
mol modselect 39 top {index 47 27}
