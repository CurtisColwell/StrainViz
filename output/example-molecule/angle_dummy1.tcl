# Minimum value: 1.51536510291e-05
# Maximum value: 0.000669456208167
...
mol modcolor 1 top {colorid 13}
mol modselect 1 top {index 1 2}

mol addrep top
mol modstyle 2 top bonds
mol modcolor 2 top {colorid 12}
mol modselect 2 top {index 1 12}
...
mol modcolor 4 top {colorid 2}
mol modselect 4 top {index 2 30}

mol addrep top
mol modstyle 5 top bonds
mol modcolor 5 top {colorid 14}
mol modselect 5 top {index 3 4}

mol addrep top
mol modstyle 6 top bonds
mol modcolor 6 top {colorid 1}
mol modselect 6 top {index 3 31}

mol addrep top
mol modstyle 7 top bonds
mol modcolor 7 top {colorid 18}
mol modselect 7 top {index 4 5}

mol addrep top
mol modstyle 8 top bonds
mol modcolor 8 top {colorid 7}
mol modselect 8 top {index 4 11}

mol addrep top
mol modstyle 9 top bonds
mol modcolor 9 top {colorid 13}
mol modselect 9 top {index 5 6}

mol addrep top
mol modstyle 10 top bonds
mol modcolor 10 top {colorid 15}
mol modselect 10 top {index 5 10}

mol addrep top
mol modstyle 11 top bonds
mol modcolor 11 top {colorid 6}
mol modselect 11 top {index 6 7}

mol addrep top
mol modstyle 12 top bonds
mol modcolor 12 top {colorid 1}
mol modselect 12 top {index 6 32}

mol addrep top
mol modstyle 13 top bonds
mol modcolor 13 top {colorid 12}
mol modselect 13 top {index 7 8}

mol addrep top
mol modstyle 14 top bonds
mol modcolor 14 top {colorid 2}
mol modselect 14 top {index 7 33}

mol addrep top
mol modstyle 15 top bonds
mol modcolor 15 top {colorid 24}
mol modselect 15 top {index 8 9}

mol addrep top
mol modstyle 16 top bonds
mol modcolor 16 top {colorid 32}
mol modselect 16 top {index 8 23}

mol addrep top
mol modstyle 17 top bonds
mol modcolor 17 top {colorid 3}
mol modselect 17 top {index 9 10}

mol addrep top
mol modstyle 18 top bonds
mol modcolor 18 top {colorid 1}
mol modselect 18 top {index 9 34}

mol addrep top
mol modstyle 19 top bonds
mol modcolor 19 top {colorid 1}
mol modselect 19 top {index 10 35}

mol addrep top
mol modstyle 20 top bonds
mol modcolor 20 top {colorid 2}
mol modselect 20 top {index 11 12}

mol addrep top
mol modstyle 21 top bonds
mol modcolor 21 top {colorid 1}
mol modselect 21 top {index 11 36}

mol addrep top
mol modstyle 22 top bonds
mol modcolor 22 top {colorid 1}
mol modselect 22 top {index 12 37}

mol addrep top
mol modstyle 23 top bonds
mol modcolor 23 top {colorid 12}
mol modselect 23 top {index 16 17}

mol addrep top
mol modstyle 24 top bonds
mol modcolor 24 top {colorid 14}
mol modselect 24 top {index 16 27}

mol addrep top
mol modstyle 25 top bonds
mol modcolor 25 top {colorid 2}
mol modselect 25 top {index 17 18}

mol addrep top
mol modstyle 26 top bonds
mol modcolor 26 top {colorid 1}
mol modselect 26 top {index 17 40}

mol addrep top
mol modstyle 27 top bonds
mol modcolor 27 top {colorid 8}
mol modselect 27 top {index 18 19}

mol addrep top
mol modstyle 28 top bonds
mol modcolor 28 top {colorid 1}
mol modselect 28 top {index 18 41}

mol addrep top
mol modstyle 29 top bonds
mol modcolor 29 top {colorid 27}
mol modselect 29 top {index 19 20}

mol addrep top
mol modstyle 30 top bonds
mol modcolor 30 top {colorid 17}
mol modselect 30 top {index 19 26}

mol addrep top
mol modstyle 31 top bonds
mol modcolor 31 top {colorid 12}
mol modselect 31 top {index 20 21}

mol addrep top
mol modstyle 32 top bonds
mol modcolor 32 top {colorid 20}
mol modselect 32 top {index 20 25}

mol addrep top
mol modstyle 33 top bonds
mol modcolor 33 top {colorid 4}
mol modselect 33 top {index 21 22}

mol addrep top
mol modstyle 34 top bonds
mol modcolor 34 top {colorid 1}
mol modselect 34 top {index 21 42}

mol addrep top
mol modstyle 35 top bonds
mol modcolor 35 top {colorid 21}
mol modselect 35 top {index 22 23}

mol addrep top
mol modstyle 36 top bonds
mol modcolor 36 top {colorid 1}
mol modselect 36 top {index 22 43}

mol addrep top
mol modstyle 37 top bonds
mol modcolor 37 top {colorid 12}
mol modselect 37 top {index 23 24}

mol addrep top
mol modstyle 38 top bonds
mol modcolor 38 top {colorid 5}
mol modselect 38 top {index 24 25}

mol addrep top
mol modstyle 39 top bonds
mol modcolor 39 top {colorid 1}
mol modselect 39 top {index 24 44}

mol addrep top
mol modstyle 40 top bonds
mol modcolor 40 top {colorid 1}
mol modselect 40 top {index 25 45}

mol addrep top
mol modstyle 41 top bonds
mol modcolor 41 top {colorid 4}
mol modselect 41 top {index 26 27}

mol addrep top
mol modstyle 42 top bonds
mol modcolor 42 top {colorid 1}
mol modselect 42 top {index 26 46}

mol addrep top
mol modstyle 43 top bonds
mol modcolor 43 top {colorid 2}
mol modselect 43 top {index 27 47}
