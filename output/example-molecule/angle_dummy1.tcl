# Minimum value: 0.108053912255
# Maximum value: 2.88811644759
...
mol modcolor 1 top {colorid 18}
mol modselect 1 top {index 3 2}

mol addrep top
mol modstyle 2 top bonds
mol modcolor 2 top {colorid 9}
...
mol modcolor 6 top {colorid 22}
mol modselect 6 top {index 8 7}

mol addrep top
mol modstyle 7 top bonds
mol modcolor 7 top {colorid 19}
...
mol modcolor 9 top {colorid 10}
mol modselect 9 top {index 10 5}

mol addrep top
mol modstyle 10 top bonds
mol modcolor 10 top {colorid 9}
...
mol modcolor 19 top {colorid 21}
mol modselect 19 top {index 24 23}

mol addrep top
mol modstyle 20 top bonds
mol modcolor 20 top {colorid 7}
...
mol modcolor 38 top {colorid 8}
mol modselect 38 top {index 46 26}

mol addrep top
mol modstyle 39 top bonds
mol modcolor 39 top {colorid 12}
